...
class ManageWeaponSub
	: public Submenu {
public:
	ManageWeaponSub(MenuController *menuController, Ped ped, const WeaponData& weapon, std::function<void(WeaponData)> onEquip, std::function<void(WeaponData)> onRemove);
...
{
public:
	WeaponSelectionCatSub(MenuController* menuController, Ped ped, std::string catName, const std::vector<WeaponData>& weapons, std::function<void(WeaponData)> onEquip, std::function<void(WeaponData)> onRemove);
